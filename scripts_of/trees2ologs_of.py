...
def DoOrthologuesForOrthoFinder(ogSet, species_tree_rooted_labelled, GeneToSpecies, stride_dups, qNoRecon, hog_writer, q_split_paralogous_clades, n_parallel):   
    ...
    try:
        ...
        with open(files.FileHandler.GetDuplicationsFN(), util.csv_write_mode) as outfile_dups, OrthologsFiles(dResultsOrthologues, speciesDict, ogSet.speciesToUse, nspecies, sp_to_index) as (ologs_file_handles, putative_xenolog_file_handles):
