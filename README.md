...
5. (To run large analyses with `--core`/`--assign`, you will need to install [ASTRAL-Pro3](https://github.com/chaoszhang/ASTER) separately since it contains computer-architecture specific code. Or use conda, which will do this for you.)
