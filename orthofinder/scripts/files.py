...
class __Files_new_dont_manually_create__(object):    
    ...
    def StartFromOrthogroupsOrSequenceSearch(self, wd_base, dir_to_put_results_dir, clustersFilename_pairs=None, append_name = "", userSpeciesTree=None):
        """
        NEed to initialise:
        wd_base
        wd_trees
